## Boxplot결과 이상치 데이터가 없는 컬럼에 대한 Visualization ##
...
line_color ='#79db93'
fig=go.Figure()
fig.add_trace(go.Bar(x=df_2['연령구간코드'], y=df_2['평균신용평가점수']))
fig.update_layout(go.Layout(xaxis={'title':{'text':'연령구간코드'}},yaxis={'title':{'text':'평균신용평가점수'}}))                          
plotly.offline.plot(fig,filename='df(1) 연령구간코드별 평균신용평가점수.html')
