...
#그래프 레이아웃 설정 및 출력
fig.update_layout(title='<b>시간에 따른 연령별 라스트마일모빌리티 공유 매출건수 현황<b>', barmode='stac
k')
fig.show()
